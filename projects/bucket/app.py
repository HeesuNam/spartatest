...
client = MongoClient('mongodb+srv://Heesu:rkskekfk12@cluster0.loxm5z5.mongodb.net/?retryWrites=true&w=majority')
db = client.dbsparta
...
def bucket_cancel():
    num_receive = request.form['num_give']
    db.buckets.update_one({'num': int(num_receive)}, {'$set': {'done': 0}})
